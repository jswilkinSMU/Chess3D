...
void App::Startup()
{
	...
	networkConfig.m_numClients = 4;
	networkConfig.m_port = "3100";
	networkConfig.m_address = "127.0.0.1";
...
void App::Update()
{
	if (g_theDevConsole->GetMode() == DevConsoleMode::OPEN_FULL || g_theGame->m_currentState == GameState::ATTRACT || GetActiveWindow() != Window::s_mainWindow->GetHwnd())
	{
